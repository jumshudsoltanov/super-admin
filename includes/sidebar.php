 <aside id="sidebar" class="sidebar">
     ...
     <ul class="sidebar-nav" id="sidebar-nav">
         ...
         <li class="nav-item">
             <a class="nav-link <?= isActive(['restaurantslist.php','restaurants.php', 'qr_generator.php'], 'd-flex align-items-center rounded-pill px-3 py-2 bg-primary text-white') ?> <?= isActive('restaurantslist.php', '', 'collapsed') ?>" href="restaurantslist.php">
                 <i class="bi bi-grid <?= isActive(['restaurantslist.php','restaurants.php', 'qr_generator.php'], 'text-white') ?> me-2"></i>
