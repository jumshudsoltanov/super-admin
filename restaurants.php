                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="is_contract" name="is_contract" value="1" <?= (isset($profiles['is_contract']) && $profiles['is_contract'] === '1') ? 'checked' : '' ?>>
                                                    <label class="form-check-label" for="is_contract">Müqavilə Var?</label>
                                                </div>
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="is_working" name="is_working" value="1" <?= (isset($profiles['is_working']) && $profiles['is_working'] === '1') ? 'checked' : '' ?>>
                                                    <label class="form-check-label" for="is_working">Bizimlə Çalışır?</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 d-flex justify-content-end">
                                                <button type="submit" name="<?= isset($_GET['e']) ? 'update' : 'send' ?>" class="btn btn-primary">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="is_pos" name="is_pos" value="1" <?= (isset($profiles['is_pos']) && $profiles['is_pos'] === '1') ? 'checked' : '' ?>>
                                                            <label class="form-check-label" for="is_pos">POS Aktivdir?</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="is_menu" name="is_menu" value="1" <?= (isset($profiles['is_menu']) && $profiles['is_menu'] === '1') ? 'checked' : '' ?>>
                                                            <label class="form-check-label" for="is_menu">Menyu Aktivdir?</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="is_tax" name="is_tax" value="1" <?= (isset($profiles['is_tax']) && $profiles['is_tax'] === '1') ? 'checked' : '' ?>>
                                                            <label class="form-check-label" for="is_tax">Vergi Aktivdir?</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="is_scroll" name="is_scroll" value="1" <?= (isset($profiles['is_scroll']) && $profiles['is_scroll'] === '1') ? 'checked' : '' ?>>
                                                            <label class="form-check-label" for="is_scroll">Scroll Aktivdir?</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="is_telegram_notify" name="is_telegram_notify" value="1" <?= (isset($profiles['is_telegram_notify']) && $profiles['is_telegram_notify'] === '1') ? 'checked' : '' ?>>
                                                            <label class="form-check-label" for="is_telegram_notify">Telegram Bildiriş</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="is_whatsapp_notify" name="is_whatsapp_notify" value="1" <?= (isset($profiles['is_whatsapp_notify']) && $profiles['is_whatsapp_notify'] === '1') ? 'checked' : '' ?>>
                                                            <label class="form-check-label" for="is_whatsapp_notify">WhatsApp Bildiriş</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="is_pos_block" name="is_pos_block" value="1" <?= (isset($profiles['is_pos_block']) && $profiles['is_pos_block'] === '1') ? 'checked' : '' ?>>
                                                            <label class="form-check-label" for="is_pos_block">POS Blok?</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox" id="is_menu_block" name="is_menu_block" value="1" <?= (isset($profiles['is_menu_block']) && $profiles['is_menu_block'] === '1') ? 'checked' : '' ?>>
                                                            <label class="form-check-label" for="is_menu_block">Menyu Blok?</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
